    ...
    def setUp(self):
        ...
        linked_artifacts = [
            ...
            for name in (
                ...
                "output/c09-offline-001/report.json",
                "output/c09-offline-001/README.md",
                "output/c09-offline-001-replay/report.json",
                "output/c09-offline-002/report.json",
                "output/c09-scoring-002/report.json",
                "output/c09-offline-003/report.json",
                "output/c09-scoring-003/report.json",
                "output/c09-live-001/report.json",
                "output/c09-live-001-replay/report.json",
                "output/c09-qualification-002/preparation.json",
                "output/c09-qualification-live-002/report.json",
                "output/c09-response-diagnostic-002/report.json",
                "output/c09-structured-smoke-001/report.json",
                "output/c10-local-001/operations.json",
                "output/c10-local-001/inventory.json",
                "output/c10-platform-002/report.json",
                "output/c10-platform-linux-001/collection-failure.xml",
                "output/c10-platform-linux-002/preflight.json",
                "output/c10-platform-linux-002/tests.xml",
                "output/c09-policy-003/preparation.json",
                ...
                "output/c06-live-report-249/leaderboard.md",
